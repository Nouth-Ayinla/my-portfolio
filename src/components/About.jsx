            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              <div className="flex items-center gap-3 p-3 bg-white dark:bg-gray-700 rounded-lg shadow-sm">
                ...
                <div>
                  ...
                  <span className="ml-2 dark:text-gray-300">Oluwaferanmi</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-3 bg-white dark:bg-gray-700 rounded-lg shadow-sm">
                ...
                <div>
                  ...
                  <span className="ml-2 dark:text-gray-300">shawolhorizon@gmail.com</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-3 bg-white dark:bg-gray-700 rounded-lg shadow-sm">
                ...
                <div>
                  ...
                  <span className="ml-2 dark:text-gray-300">Nigeria</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-3 bg-white dark:bg-gray-700 rounded-lg shadow-sm">
                ...
                <div>
                  ...
                  <span className="ml-2 dark:text-gray-300">3+ Years</span>
                </div>
              </div>
            </div>
